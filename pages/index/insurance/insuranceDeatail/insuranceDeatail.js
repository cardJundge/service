...
Page({
  ...
  unpassReason: function (e) {
    detail.unpassReason(e, this, this.data.listId, this.data.sessionId, 'sale')
  },
  ...
  confirmCancel: function () {
    detail.confirmCancel(this, this.data.listId, this.data.sessionId, 'sale')
  ...
  confirmDelete: function () {
    detail.confirmDelete(this, this.data.listId, this.data.sessionId, 'sale')
  ...
  toEdit: function () {
    ...
    wx.navigateTo({
      url: '../editinsuranceDeatail/editinsuranceDeatail?module=' + this.data.detailId,
    })
  },
  link: function (e) {
  ...
  toSelectPeople: function () {
    ...
    wx.navigateTo({
      url: '../../allot/allot?module=' + this.data.detailId + '&moduleis=8',
    })
  },
  ...
  onShow: function () {
    ...
    detail.getDetail(that, that.data.sessionId, that.data.listId, 'sale', 8)
  },
  checkPass: function () {
    var that = this

    detail.checkPass(that, that.data.listId, this.data.sessionId, 'sale')
